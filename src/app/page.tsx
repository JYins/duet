  ...
  return (
    <main className="relative flex flex-1 flex-col items-center justify-center overflow-hidden bg-[#F5F2EA]">
      ...
      >
        ...
        {/* tagline — editorial scale contrast */}
        <motion.p
          variants={fadeUp}
          className="mt-8 max-w-[260px] text-center text-[13px] leading-[1.7] tracking-[0.02em] text-[#8A8780] sm:max-w-xs sm:text-sm"
        >
        ...
        {/* join code — appears as a quiet secondary option */}
        <motion.div
          variants={fadeUp}
        ...
        >
          ...
          <span className="text-[8px] tracking-[0.2em] text-[#D4A574]/30 uppercase sm:text-[9px]">
            on-device · private · collaborative
          </span>
        </motion.div>
      </motion.div>
    </main>
